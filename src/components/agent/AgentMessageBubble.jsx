...
const FunctionDisplay = ({ toolCall }) => {
    ...
    const statusConfig = {
        ...
        running: { icon: Loader2, color: 'text-indigo-500', text: 'Executando...', spin: true },
        in_progress: { icon: Loader2, color: 'text-indigo-500', text: 'Executando...', spin: true },
        completed: isError ? 
...
export default function AgentMessageBubble({ message }) {
    ...
    return (
        <div className={cn("flex gap-3", isUser ? "justify-end" : "justify-start")}>
            {!isUser && (
                <div className="h-8 w-8 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center mt-0.5 flex-shrink-0">
