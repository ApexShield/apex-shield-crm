...
export default function PullToRefresh({ onRefresh, children, className = "" }) {
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      >
        <div
          className={`w-8 h-8 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center ${refreshing ? "animate-spin" : ""}`}
      ...
      <div
        ...
        style={{
          transform: showIndicator && !refreshing ? `translateY(${pullDistance}px)` : refreshing ? "translateY(48px)" : "translateY(0)",
